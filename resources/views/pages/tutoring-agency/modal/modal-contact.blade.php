                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            <input type="text" name="office_phone" class="form-control has-feedback-left" placeholder="Office Phone" maxlength="25">
                            <span class="fa fa-phone form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            <input type="text" name="mobile_phone" class="form-control has-feedback-left" placeholder="Mobile Phone" maxlength="25">
